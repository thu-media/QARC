...
class TinyQueue:
    def __init__(self, maxsize=1024 * 1024 * 10, queue=None, front=0, end=0, size=0, starttime=0):
        if queue is None:
    ...
    def copy(self):
        _queue = TinyQueue(queue=self._queue.copy(), front=self._front,
                           end=self._end, starttime=self._starttime, maxsize=self._maxsize)
        return _queue
